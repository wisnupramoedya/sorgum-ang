...
import {ParamSelectItem} from "../../../../../../common/plan-detailparameter.model";
import {PlanDetailParameterService} from "../../../../../../api-services/plan-detail-parameter.service";
...
@Component({
  selector: 'app-create-plan-detail',
  standalone: true,
  templateUrl: './create-plan-detail.component.html',
  styleUrls: ['./create-plan-detail.component.scss'],
  imports: [
    CommonModule,
    ReactiveFormsModule,
    FormsModule,
...
export class CreatePlanDetailComponent implements OnInit {
  ...
  submitForm():void{
    ...
    if(this.form.valid){
      this.PlanDetailService.add(this.form.value)
          .pipe(
